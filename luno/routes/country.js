...
router.get('/', function(req, res, next) {
    ...
    database.query('SELECT DISTINCT country FROM country_state_city ORDER BY country ASC', function(error, country_data){

        res.render('country', { title: 'Express', country_data : country_data });
